 ...
 */
public class SynchronizedRpsEnforcerTest {
    @Test
    public void testExactRps() {
        SynchronizedRpsEnforcer enforcer = new SynchronizedRpsEnforcer(1);
    ...
    public void testSecondBoundaryBig() {
        SynchronizedRpsEnforcer enforcer = new SynchronizedRpsEnforcer(1000);
